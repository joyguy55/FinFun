...
<div class="sticker_picker_margin">
  <div class="sticker_picker_container">
    <button type="button" class="close close_box" aria-label="Close" v-on:click="closeColorBox()">
        <span aria-hidden="true">&times;</span>
    </button>
    <button id="sticker_button" class="sticker_box" v-for="sticker in stickerSet" type="button" v-on:click="selectSticker({index:position, id:sticker.id})">
